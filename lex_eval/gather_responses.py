        ...
        for attempt in range(1, max_retries + 1):
            ...
            if actual_output:
                return {
                    ...
                    "retrieval_context": json.dumps(capture_result.get("retrieval_context", [])),
                    "tools_called": json.dumps(capture_result.get("tools_called", [])),
                    "research_output": capture_result.get("research_output", ""),
                    "research_mode": research_mode,
                    "case_law_context": json.dumps(capture_result.get("case_law_context", [])),
                    "tool_sequence": json.dumps(capture_result.get("tool_sequence", [])),
                    "fallback_used": capture_result.get("fallback_used", False),
                    "summarisation_output": json.dumps(capture_result.get("summarisation_output", [])),
                ...
                if attempt == max_retries:
                    return {
                        ...
                        "is_error": True,
                        "error_message": "Empty actual_output after retries",
                    }
    finally:
        client.close()
